class Model {
  ...
  String get haematocrit_41 => _41_haematocrit!; //ヘマトクリット
  ...
  set haematocrit(String value) {
    _41_haematocrit = value;
  }
  ...
  Map<String, dynamic> toMap() {
    ...
    map['haematocrit'] = _41_haematocrit;
    map['mcv'] = _42_mcv;
    map['mch'] = _43_mch;
    map['mchc'] = _44_mchc;
  ...
  Model.fromMapObject(Map<String, dynamic> map) {
    ...
    _41_haematocrit = map['haematocrit'];
    _42_mcv = map['mcv'];
    _43_mch = map['mch'];
    _44_mchc = map['mchc'];
